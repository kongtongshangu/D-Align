...
from .our_vit import create_model_d_align as create_model_d_align
...
common_corruptions = OrderedDict(
    [
        ...
        ('Standard_VITB_D_Align', {
            'model': lambda: create_model_d_align("vit_base_patch16_224", pretrained=True),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
    ])
