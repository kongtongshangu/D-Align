...
PREPROCESSINGS = {
    ...
    'Res518': transforms.Compose([transforms.Resize(518),
                                         transforms.ToTensor(),
                                         ]),
}
...
def load_imagenetc(
    ...
    test_loader = data.DataLoader(imagenet, batch_size=n_examples, shuffle=shuffle, num_workers=2)
...
def load_imagenet3dcc(
    ...
    data_folder_path = Path(data_dir) / corruptions[0] / str(severity)
    imagenet = CustomImageFolder(data_folder_path, transforms_test)
